        ...
        try
        {
            if (currentGameState == GAME_STATE.PLAYING)
            {
                    ...
                    currentStatus == STATE_OF_PLAYER.AT_START)  //  At Start
                {
                    ...
                    currentStatus == STATE_OF_PLAYER.AT_START)  //  At Start
                {
                    transform.Translate(-Math.Abs(MoveAlongZ2Level2.speed[0]) - 0.02f, 0, 0);
                }

                if (currentStatus == STATE_OF_PLAYER.PLAYING_OBJ0)
                {
                    transform.Translate(-MoveAlongZLevel2.speed[currentPosition / 2], 0, 0);
                }

                else if (currentStatus == STATE_OF_PLAYER.PLAYING_OBJ1)
                {
                    transform.Translate(-MoveAlongZ2Level2.speed[currentPosition / 2], 0, 0);
                }
